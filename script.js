    ...
    if (picked) {
      if (picked.dataset.id === target.dataset.id) {
        ...
        setTimeout(() => {
          target.classList.remove("card--picked");
          picked.classList.remove("card--picked");
          target.classList.add("card--shake");
          picked.classList.add("card--shake");
          setTimeout(() => {
            target.classList.remove("card--shake");
            picked.classList.remove("card--shake");
            isPaused = false;
          }, 500);
        }, 1500);
      }
